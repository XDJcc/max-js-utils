...
describe('deepClone 函数', function () {
  test('应该深度克隆一个简单的对象', function () {
    ...
    var clonedObj = (0, _deepClone.deepClone)(obj);
  ...
  test('应该深度克隆一个 Map 对象', function () {
    ...
    var clonedMap = (0, _deepClone.deepClone)(originalMap);
  ...
  test('应该深度克隆一个 Set 对象', function () {
    ...
    var clonedSet = (0, _deepClone.deepClone)(originalSet);
  ...
  test('应该深度克隆一个数组', function () {
    ...
    var clonedArr = (0, _deepClone.deepClone)(arr);
  ...
  test('应该处理原始值（非对象类型）', function () {
    // 对于原始值，克隆后的值应与原值相同
    expect((0, _deepClone.deepClone)(42)).toBe(42);
    expect((0, _deepClone.deepClone)('test')).toBe('test');
    expect((0, _deepClone.deepClone)(null)).toBeNull();
    expect((0, _deepClone.deepClone)(undefined)).toBeUndefined();
  });
  test('应该处理 Date 对象', function () {
    var date = new Date('2024-01-01');
    var clonedDate = (0, _deepClone.deepClone)(date);
  ...
  test('应该处理 RegExp 对象', function () {
    var regex = /abc/i;
    var clonedRegex = (0, _deepClone.deepClone)(regex);
...
describe('deepCloneFunction 函数', function () {
  test('应该深度克隆一个函数', function () {
    ...
    var clonedFunc = (0, _deepClone.deepCloneFunction)(func);
  ...
  test('应该保持原函数的原型链', function () {
    ...
    var clonedPerson = (0, _deepClone.deepCloneFunction)(Person);
